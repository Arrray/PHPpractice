...
<table id="regfm" width="500" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td height="25" colspan="3" align="center" valign="middle">网络U盘注册页面</td>
    </tr>
  <tr>
...
<div style=" text-align:center;text-align:center; width:50%; height:25px; line-height:25px;"><button id="regbtn" class="btn" disabled="disabled">注册</button>&nbsp;<button id="morebtn" class="btn">详细信息</button></div></center>
<!--省略部分代码-->