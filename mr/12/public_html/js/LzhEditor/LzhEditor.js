...
function changeEditorArea(type) {
	if (type == 1) {
		document.getElementById("editor").height = parseInt(document
				.getElementById("editor").height) + 50;
	} else {
...
var LzhEditor = function(fieldName, width, height, value, baseUrl,
	...
	this.uploadFileUrl = uploadFileUrl || "/upload.php"
	this.editorStr = "";
...
LzhEditor.prototype.Create = function() {
	...
	this.editorStr += "<div id=\"faceLayer\" style=\"position: absolute; width:445px; left:310px; top:25px; z-index: 1; border:1px solid #77B7DD; background-color:#F2F9F9; clear:both;  display:none;\" onmouseleave=\"this.style.display='none'\">";
	...
	this.editorStr += "<div id=\"uploadLayer\" style=\"position: absolute; width:300px; left:290px; top:25px; z-index: 1; border:1px solid #77B7DD; background-color:#F2F9F9; clear:both;  display:none;\" >";
	this.editorStr += "    <div style=\"width:100%; height:25px; clear:both;\">";
	this.editorStr += "       URL插入：<input name=\"r1\" type=\"radio\" checked onclick=\"changUploadLayer(0)\"/>　上传后插入：<input name=\"r1\" type=\"radio\" onclick=\"changUploadLayer(1)\"/>　　　 　<a onclick=\"javascript:document.getElementById('uploadLayer').style.display='none';\" style=\"cursor:pointer;\">关闭</a>";
	this.editorStr += "    </div>";
	...
	this.editorStr += "        <iframe src=\"" + this.uploadFileUrl
