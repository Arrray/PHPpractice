<?php /* Smarty version 2.6.19, created on 2009-06-09 08:55:19
         compiled from admin-listmrbookph.phtml */ ?>
...
/admin-listmrbookph.php'"/></div>    
    <div style="width:98%;  border:1px solid #006D84">
        <div style="width:100%; height:25px; border:1px solid #FFFFFF; background-color:#4995A8; text-align:left; padding-top:5px; padding-left:20px; color:#FFFFFF">
            <li style="display:inline; float:left"><strong>浏览图书排行信息</strong></li>
        </div>
...
/admin-mrbookph.php?f=edit&id=<?php echo $this->_tpl_vars['tells']['data'][$this->_sections['tID']['index']]['id']; ?>
...
/admin-listmrbookph.php?f=del&id=<?php echo $this->_tpl_vars['tells']['data'][$this->_sections['tID']['index']]['id']; ?>
';}"><img src="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
...
&nbsp;页&nbsp;&nbsp;&nbsp;&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/admin-listmrbookph.php?page=<?php echo $this->_tpl_vars['tells']['first']; ?>
" class="a1">首页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/admin-listmrbookph.php?page=<?php echo $this->_tpl_vars['tells']['previous']; ?>
" class="a1">上一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/admin-listmrbookph.php?page=<?php echo $this->_tpl_vars['tells']['next']; ?>
" class="a1">下一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/admin-listmrbookph.php?page=<?php echo $this->_tpl_vars['tells']['last']; ?>
" class="a1">尾页</a>
          </li>           
          <?php endif; ?>
    </div>   
