...
/img/title4.gif); border-top:1px solid #CCCCCC; padding-top:5px; text-align:left; padding-left:20px; font-size:13px">
                      您当前的位置：明日网上书店&nbsp;>>&nbsp;<?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['bigtype'][0]['typename']);?>
类图书专区&nbsp;>>&nbsp;<?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['smalltype'][0]['typename']);?>
类图书         
    </div>    
    <div style="width:930px; height:60px; text-align:left; padding-top:5px; background-color:#F7F7F7; line-height:22px; padding-left:30px">
        <font color="#990000">·排序方式：</font><br>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listbook-<?php echo $this->_tpl_vars['page']; ?>
-1-<?php echo $this->_tpl_vars['cctype']; ?>
-<?php echo $this->_tpl_vars['stid']; ?>
.html" class="<?php if ($this->_tpl_vars['pltype'] == '1'): ?>a31<?php else: ?>a3<?php endif; ?>">上架时间</a>&nbsp;|&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listbook-<?php echo $this->_tpl_vars['page']; ?>
-2-<?php echo $this->_tpl_vars['cctype']; ?>
-<?php echo $this->_tpl_vars['stid']; ?>
.html" class="<?php if ($this->_tpl_vars['pltype'] == '2'): ?>a31<?php else: ?>a3<?php endif; ?>">出版时间</a>&nbsp;|&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listbook-<?php echo $this->_tpl_vars['page']; ?>
-3-<?php echo $this->_tpl_vars['cctype']; ?>
-<?php echo $this->_tpl_vars['stid']; ?>
.html" class="<?php if ($this->_tpl_vars['pltype'] == '3'): ?>a31<?php else: ?>a3<?php endif; ?>">价格由低到高</a>&nbsp;|&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listbook-<?php echo $this->_tpl_vars['page']; ?>
-4-<?php echo $this->_tpl_vars['cctype']; ?>
-<?php echo $this->_tpl_vars['stid']; ?>
.html" class="<?php if ($this->_tpl_vars['pltype'] == '4'): ?>a31<?php else: ?>a3<?php endif; ?>">浏览次数由多到少</a>&nbsp;    
                       <br>
        <font color="#990000">·图书层次：</font><br>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listbook-<?php echo $this->_tpl_vars['page']; ?>
-<?php echo $this->_tpl_vars['pltype']; ?>
-1-<?php echo $this->_tpl_vars['stid']; ?>
.html" class="<?php if ($this->_tpl_vars['cctype'] == '1'): ?>a31<?php else: ?>a3<?php endif; ?>">全部</a>&nbsp;|&nbsp; <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listbook-<?php echo $this->_tpl_vars['page']; ?>
-<?php echo $this->_tpl_vars['pltype']; ?>
-2-<?php echo $this->_tpl_vars['stid']; ?>
.html" class="<?php if ($this->_tpl_vars['cctype'] == '2'): ?>a31<?php else: ?>a3<?php endif; ?>">初级入门</a>&nbsp;|&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listbook-<?php echo $this->_tpl_vars['page']; ?>
-<?php echo $this->_tpl_vars['pltype']; ?>
-3-<?php echo $this->_tpl_vars['stid']; ?>
.html" class="<?php if ($this->_tpl_vars['cctype'] == '3'): ?>a31<?php else: ?>a3<?php endif; ?>">提高必备</a>&nbsp;|&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/listbook-<?php echo $this->_tpl_vars['page']; ?>
-<?php echo $this->_tpl_vars['pltype']; ?>
-4-<?php echo $this->_tpl_vars['stid']; ?>
.html" class="<?php if ($this->_tpl_vars['cctype'] == '4'): ?>a31<?php else: ?>a3<?php endif; ?>">高级导向 </a>                                       
    </div>  
    <div style="width:930px; height:25px; border-top:1px dotted #CCCCCC; padding-top:5px; text-align:left; padding-left:20px; background-color:#FFFBE5">
        <li style="display:inline"> 当前排列方式：</li>
        <li style="background-color:#EAEDEE; display:inline; width:120px; height:16px; text-align:center; padding-top:2px">
         ...
         <li style="display:inline; padding-left:20px">当前图书层次： </li>
         <li style="background-color:#EAEDEE; display:inline; width:90px; height:16px; text-align:center; padding-top:2px">
          ...
          <li style="display:inline; padding-left:20px">该类图书共&nbsp;<?php echo $this->_tpl_vars['bookinfos']['countRs']; ?>
