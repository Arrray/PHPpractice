<?php /* Smarty version 2.6.19, created on 2009-06-06 00:58:37
         compiled from tell.phtml */ ?>
...
/tell-1.html" class="<?php if ($this->_tpl_vars['cctype'] == 1): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>全部</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tell-2.html" class="<?php if ($this->_tpl_vars['cctype'] == 2): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>初级</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tell-3.html" class="<?php if ($this->_tpl_vars['cctype'] == 3): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>中级</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tell-4.html" class="<?php if ($this->_tpl_vars['cctype'] == 4): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>高级</strong></a></div>
                </div>    
                <div style="width:6px; height:30px; background:url(<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
...
/tellinfo-<?php echo $this->_tpl_vars['tells']['data'][$this->_sections['tID']['index']]['id']; ?>
.html" class="a1">·<?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['tells']['data'][$this->_sections['tID']['index']]['title']);?>
</a></li>
                <li style="display:inline; width:20%; float:right; text-align:right"><?php echo $this->_reg_objects['util'][0]->msubstr($this->_tpl_vars['tells']['data'][$this->_sections['tID']['index']]['addtime'],0,10);?>
</li>
            </div>
            <?php endfor; endif; ?>
            <br />
            ...
            <div style="width:88%; text-align:left">
                <li style="display:inline; padding-left:20px">共有公告信息&nbsp;<?php echo $this->_tpl_vars['tells']['countRs']; ?>
...
/tell-<?php echo $this->_tpl_vars['tells']['first']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">首页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tell-<?php echo $this->_tpl_vars['tells']['previous']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">上一页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tell-<?php echo $this->_tpl_vars['tells']['next']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">下一页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tell-<?php echo $this->_tpl_vars['tells']['last']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">尾页</a>
                </li>  
            </div>
