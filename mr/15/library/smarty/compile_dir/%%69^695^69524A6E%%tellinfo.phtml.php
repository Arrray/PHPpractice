<?php /* Smarty version 2.6.19, created on 2009-06-09 06:43:01
         compiled from tellinfo.phtml */ ?>
...
/tellinfo-<?php echo $this->_tpl_vars['tid']; ?>
-1.html" class="<?php if ($this->_tpl_vars['cctype'] == 1): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>全部</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tellinfo-<?php echo $this->_tpl_vars['tid']; ?>
-2.html" class="<?php if ($this->_tpl_vars['cctype'] == 2): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>初级</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tellinfo-<?php echo $this->_tpl_vars['tid']; ?>
-3.html" class="<?php if ($this->_tpl_vars['cctype'] == 3): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>中级</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/tellinfo-<?php echo $this->_tpl_vars['tid']; ?>
-4.html" class="<?php if ($this->_tpl_vars['cctype'] == 4): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>高级</strong></a></div>
                </div>    
                <div style="width:6px; height:30px; background:url(<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
        ...
        <div style="width:700px; height:100%; float:right">
            ...
            <div style="width:100%">
                <div style="width:95%; height:35px; text-align:left; border-bottom:1px dotted #333333; padding-top:12px; font-size:13px; color:#003399">
                    <li style="display:inline; width:450px; float:left"><strong> 主题： <?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['tell'][0]['title']);?>
</strong></li>
                    <li style="dispaly:inline; width:180px; float:right">发布时间：<?php echo $this->_reg_objects['util'][0]->msubstr($this->_tpl_vars['tell'][0]['addtime'],0,10);?>
</li>   
                </div>
                <div style="width:95%; text-align:left; padding-top:15px; line-height:20px; font-size:14px">
                     <?php echo $this->_reg_objects['util'][0]->editorUnHtml($this->_tpl_vars['tell'][0]['content']);?>
