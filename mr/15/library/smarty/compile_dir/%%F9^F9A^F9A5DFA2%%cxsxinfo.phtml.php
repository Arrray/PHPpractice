<?php /* Smarty version 2.6.19, created on 2009-06-06 00:43:54
         compiled from cxsxinfo.phtml */ ?>
...
/cxsxinfo-1-<?php echo $this->_tpl_vars['cid']; ?>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/cxsxinfo-2-<?php echo $this->_tpl_vars['cid']; ?>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/cxsxinfo-3-<?php echo $this->_tpl_vars['cid']; ?>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/cxsxinfo-4-<?php echo $this->_tpl_vars['cid']; ?>
        ...
        <div style="width:700px; height:100%; float:right">
            ...
            <div style="width:100%">
                <div style="width:95%; height:35px; text-align:left; border-bottom:1px dotted #333333; padding-top:12px; font-size:13px; color:#003399">
                    <li style="display:inline; width:450px; float:left"><strong> 主题： <?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['cxsx'][0]['title']);?>
</strong></li>
                    <li style="dispaly:inline; width:180px; float:right">发布时间：<?php echo $this->_reg_objects['util'][0]->msubstr($this->_tpl_vars['cxsx'][0]['addtime'],0,10);?>
</li>   
                </div>
                <div style="width:95%; text-align:left; padding-top:15px; line-height:20px; font-size:14px">
                     <?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['cxsx'][0]['content']);?>
