<?php /* Smarty version 2.6.19, created on 2009-06-06 09:05:44
         compiled from pubbook.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'pubbook.phtml', 32, false),)), $this); ?>
...
/pubbook-<?php echo $this->_tpl_vars['bookinfos']['first']; ?>
-<?php echo $this->_tpl_vars['pubid']; ?>
.html" class="a1">首页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pubbook-<?php echo $this->_tpl_vars['bookinfos']['previous']; ?>
-<?php echo $this->_tpl_vars['pubid']; ?>
.html" class="a1">上一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pubbook-<?php echo $this->_tpl_vars['bookinfos']['next']; ?>
-<?php echo $this->_tpl_vars['pubid']; ?>
.html" class="a1">下一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pubbook-<?php echo $this->_tpl_vars['bookinfos']['last']; ?>
-<?php echo $this->_tpl_vars['pubid']; ?>
.html" class="a1">尾页</a>
          </li>           
          <?php endif; ?>
...
/img/mark_telllogin.gif"><br />
                    <strong>对不起，暂无<?php echo $this->_tpl_vars['nowtype']; ?>
信息！</strong>
    </div>
    <?php endif; ?>
