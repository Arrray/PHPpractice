<?php /* Smarty version 2.6.19, created on 2009-06-09 08:41:08
         compiled from admin-listcxsx.phtml */ ?>
...
/admin-listcxsx.php'"/></div>    
    <div style="width:98%;  border:1px solid #006D84">
        <div style="width:100%; height:25px; border:1px solid #FFFFFF; background-color:#4995A8; text-align:left; padding-top:5px; padding-left:20px; color:#FFFFFF">
            <li style="display:inline; float:left"><strong>浏览畅销书询信息</strong></li>
        </div>
...
/admin-cxsx.php?f=edit&id=<?php echo $this->_tpl_vars['tells']['data'][$this->_sections['tID']['index']]['id']; ?>
...
/admin-listcxsx.php?f=del&id=<?php echo $this->_tpl_vars['tells']['data'][$this->_sections['tID']['index']]['id']; ?>
';}"><img src="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
...
&nbsp;页&nbsp;&nbsp;&nbsp;&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/admin-listcxsx.php?page=<?php echo $this->_tpl_vars['tells']['first']; ?>
" class="a1">首页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/admin-listcxsx.php?page=<?php echo $this->_tpl_vars['tells']['previous']; ?>
" class="a1">上一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/admin-listcxsx.php?page=<?php echo $this->_tpl_vars['tells']['next']; ?>
" class="a1">下一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/admin-listcxsx.php?page=<?php echo $this->_tpl_vars['tells']['last']; ?>
" class="a1">尾页</a>
          </li>           
          <?php endif; ?>
    </div>   
