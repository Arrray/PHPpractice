<?php /* Smarty version 2.6.19, created on 2009-06-10 04:09:51
         compiled from search.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'search.phtml', 43, false),)), $this); ?>
...
/img/title4.gif); border-top:1px solid #CCCCCC; padding-top:3px; padding-left:20px; font-size:13px; text-align:left">
    ...
    <div style="width:930px; height:25px; border-top:1px dotted #CCCCCC; padding-top:5px; text-align:left; padding-left:20px; background-color:#FFFBE5">
          ...
          <?php if ($this->_tpl_vars['stype'] == 'simple'): ?>
          <li style="display:inline; padding-left:20px">共查找到相关图书&nbsp;<?php echo $this->_tpl_vars['bookinfos']['countRs']; ?>
...
/search-<?php echo $this->_tpl_vars['bookinfos']['first']; ?>
-<?php echo $this->_tpl_vars['key']; ?>
-simple.html" class="a1">首页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/search-<?php echo $this->_tpl_vars['bookinfos']['previous']; ?>
-<?php echo $this->_tpl_vars['key']; ?>
-simple.html" class="a1">上一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/search-<?php echo $this->_tpl_vars['bookinfos']['next']; ?>
-<?php echo $this->_tpl_vars['key']; ?>
-simple.html" class="a1">下一页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/search-<?php echo $this->_tpl_vars['bookinfos']['last']; ?>
-<?php echo $this->_tpl_vars['key']; ?>
-simple.html" class="a1">尾页</a>
          </li>  
          <?php elseif ($this->_tpl_vars['stype'] == 'adv'): ?>
          <li style="display:inline; padding-left:20px">共查找到相关图书&nbsp;<?php echo $this->_tpl_vars['bookinfos']['countRs']; ?>
&nbsp;本&nbsp;&nbsp;每页显示&nbsp;<?php echo $this->_tpl_vars['bookinfos']['pageSize']; ?>
&nbsp;本&nbsp;&nbsp;第&nbsp;<?php echo $this->_tpl_vars['bookinfos']['page']; ?>
&nbsp;页/共&nbsp;<?php echo $this->_tpl_vars['bookinfos']['countPage']; ?>
...
/search-<?php echo $this->_tpl_vars['bookinfos']['first']; ?>
-<?php echo $this->_tpl_vars['key']; ?>
-<?php echo $this->_tpl_vars['writer']; ?>
-<?php echo $this->_tpl_vars['fyear']; ?>
-<?php echo $this->_tpl_vars['fmonth']; ?>
-<?php echo $this->_tpl_vars['tyear']; ?>
-<?php echo $this->_tpl_vars['tmonth']; ?>
-<?php echo $this->_tpl_vars['pubid']; ?>
-<?php echo $this->_tpl_vars['smalltypeid']; ?>
-adv.html" class="a1">首页</a>&nbsp;
              <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/search-<?php echo $this->_tpl_vars['bookinfos']['previous']; ?>
-<?php echo $this->_tpl_vars['key']; ?>
-<?php echo $this->_tpl_vars['writer']; ?>
...
/bookinfo-<?php echo $this->_tpl_vars['bookinfos']['data'][$this->_sections['pbID']['index']]['id']; ?>
.html" class="a5"><strong><?php echo $this->_reg_objects['util'][0]->setRed($this->_tpl_vars['arrayKeyWord'],$this->_tpl_vars['bookinfos']['data'][$this->_sections['pbID']['index']]['bookname']);?>
</strong></a></li>
                <br><br>
...
/img/button_info.gif" border="0"/></a></li>                            
    ...
    <?php endfor; endif; ?>  
    <?php else: ?>
    <div style="width:550px; height:80px; font-size:14px">
...
/img/mark_telllogin.gif"><br />
                    <strong>对不起，没有查找到您要找的图书！</strong></li>
        <li style="display: inline; width:100%; text-align:left; padding-top:10px; line-height:20px">
        注意：请按如下提示查找您要找的图书：<br />
        &nbsp;&nbsp;·查询关键字之间要求用空格分割<br />
        &nbsp;&nbsp;·请尝试更换其他查选关键字<br />
        &nbsp;&nbsp;·如果没有查找到您要购买的图书，请拨打我公司的服务热线咨询该书相关信息<br />   
        </li>
