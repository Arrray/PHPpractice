<?php /* Smarty version 2.6.19, created on 2009-06-05 11:53:27
         compiled from mrbookph.phtml */ ?>
...
/mrbookph-1.html" class="<?php if ($this->_tpl_vars['cctype'] == 1): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>全部</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/mrbookph-2.html" class="<?php if ($this->_tpl_vars['cctype'] == 2): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>初级</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/mrbookph-3.html" class="<?php if ($this->_tpl_vars['cctype'] == 3): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>中级</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/mrbookph-4.html" class="<?php if ($this->_tpl_vars['cctype'] == 4): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>高级</strong></a></div>
                </div>    
                <div style="width:6px; height:30px; background:url(<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
...
$this->_sections['tID']['loop'] = is_array($_loop=$this->_tpl_vars['mrbookphs']['data']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/mrbookphinfo-<?php echo $this->_tpl_vars['mrbookphs']['data'][$this->_sections['tID']['index']]['id']; ?>
.html" class="a1">·<?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['mrbookphs']['data'][$this->_sections['tID']['index']]['title']);?>
</a></li>
                <li style="display:inline; width:20%; float:right; text-align:right"><?php echo $this->_reg_objects['util'][0]->msubstr($this->_tpl_vars['mrbookphs']['data'][$this->_sections['tID']['index']]['addtime'],0,10);?>
</li>
            </div>
            <?php endfor; endif; ?>
            <br />
            ...
            <div style="width:88%; text-align:left">
                <li style="display:inline; padding-left:20px">共有明日图书排行信息&nbsp;<?php echo $this->_tpl_vars['mrbookphs']['countRs']; ?>
&nbsp;条&nbsp;&nbsp;每页显示&nbsp;<?php echo $this->_tpl_vars['mrbookphs']['pageSize']; ?>
&nbsp;条&nbsp;&nbsp;第&nbsp;<?php echo $this->_tpl_vars['mrbookphs']['page']; ?>
&nbsp;页/共&nbsp;<?php echo $this->_tpl_vars['mrbookphs']['countPage']; ?>
&nbsp;页&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/mrbookph-<?php echo $this->_tpl_vars['mrbookphs']['first']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">首页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/mrbookph-<?php echo $this->_tpl_vars['mrbookphs']['previous']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">上一页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/mrbookph-<?php echo $this->_tpl_vars['mrbookphs']['next']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">下一页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/mrbookph-<?php echo $this->_tpl_vars['mrbookphs']['last']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">尾页</a>
                </li>  
            </div>
