<?php /* Smarty version 2.6.19, created on 2009-06-05 11:39:59
         compiled from pub.phtml */ ?>
...
/pub-1.html" class="<?php if ($this->_tpl_vars['cctype'] == 1): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>全部</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pub-2.html" class="<?php if ($this->_tpl_vars['cctype'] == 2): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>初级</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pub-3.html" class="<?php if ($this->_tpl_vars['cctype'] == 3): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>中级</strong></a></div>
...
/img/dg_button_bg.gif)<?php endif; ?>"><a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pub-4.html" class="<?php if ($this->_tpl_vars['cctype'] == 4): ?>a2<?php else: ?>a1<?php endif; ?>"><strong>高级</strong></a></div>
                </div>    
                <div style="width:6px; height:30px; background:url(<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
...
-<?php if ($this->_tpl_vars['cctype'] == 1): ?>1<?php elseif ($this->_tpl_vars['cctype'] == 2): ?>2<?php elseif ($this->_tpl_vars['cctype'] == 3): ?>3<?php elseif ($this->_tpl_vars['cctype'] == 4): ?>4<?php endif; ?>.html" class="a4"><?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['smalltypes'][$this->_sections['sID']['index']]['typename']);?>
        ...
        <div style="width:700px; height:100%; float:right">
            <div style="width: 100%; height:30px; text-align:left; padding-top:6px; border-bottom:1px solid #CCCCCC">
                                         当前位置：明日网上书店&nbsp;>>&nbsp;按出版社名称查看图书
            </div>  
            <br />
            <?php unset($this->_sections['tID']);
$this->_sections['tID']['name'] = 'tID';
$this->_sections['tID']['loop'] = is_array($_loop=$this->_tpl_vars['pubs']['data']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
/pubbook-<?php echo $this->_tpl_vars['pubs']['data'][$this->_sections['tID']['index']]['id']; ?>
.html" class="a1">·<?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['pubs']['data'][$this->_sections['tID']['index']]['pubname']);?>
</a></li>
                <li style="display:inline; width:20%; float:right; text-align:right"><?php echo $this->_reg_objects['util'][0]->msubstr($this->_tpl_vars['pubs']['data'][$this->_sections['tID']['index']]['addtime'],0,10);?>
</li>
            </div>
            <?php endfor; endif; ?>
            <br />
            ...
            <div style="width:88%; text-align:left">
                <li style="display:inline; padding-left:20px">共有出版社名称&nbsp;<?php echo $this->_tpl_vars['pubs']['countRs']; ?>
&nbsp;条&nbsp;&nbsp;每页显示&nbsp;<?php echo $this->_tpl_vars['pubs']['pageSize']; ?>
&nbsp;条&nbsp;&nbsp;第&nbsp;<?php echo $this->_tpl_vars['pubs']['page']; ?>
&nbsp;页/共&nbsp;<?php echo $this->_tpl_vars['pubs']['countPage']; ?>
&nbsp;页&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pub-<?php echo $this->_tpl_vars['pubs']['first']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">首页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pub-<?php echo $this->_tpl_vars['pubs']['previous']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">上一页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pub-<?php echo $this->_tpl_vars['pubs']['next']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">下一页</a>&nbsp;
                <a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/pub-<?php echo $this->_tpl_vars['pubs']['last']; ?>
-<?php echo $this->_tpl_vars['cctype']; ?>
.html" class="a1">尾页</a>
                </li>  
            </div>
