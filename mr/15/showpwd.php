...
<table width="200" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="25"><div align="center"><a href="javascript:alert('<?php echo "原密码为&nbsp;".$info[truepwd];?>');" class="a4">显示原密码</a>&nbsp;<a href="changepwd.php?userid=<?php echo $info[id];?>" class="a4">重设密码</a></div></td>
  </tr>
</table>
</body>
</html>
