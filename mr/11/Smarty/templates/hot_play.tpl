...
<a href="look.php?video_id={$video[video_id].tb_video_id}&video_name={$video[video_id].tb_video_name|escape:"url"}" target="_blank">
<img name="news" src="{$video[video_id].tb_video_picture}" width="130" height="150" alt="在线观看" border="0"/></a>
...
<table width="100%" height="25" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            <tr>
              <td><div align="left">&nbsp;&nbsp;视频&nbsp;{$total1}&nbsp;个&nbsp;每页显示&nbsp;{$pagesize1}&nbsp;个&nbsp;第&nbsp;{$page1}&nbsp;页/共&nbsp;{$pagecount1}&nbsp;页</div></td>
              <td><div align="right">

{if $page1 == 1 }首页&nbsp;上一页{else}<a href="hot_play.php?video_id={$video[video_id].tb_video_id}&video_type={$video_types}&pages=1">首页</a>&nbsp;<a href="hot_play.php?video_id={$video[video_id].tb_video_id}&video_type={$video_types}&pages={$page1-1}" >上一页</a>{/if} &nbsp;{if $page1 == $pagecount1 }下一页&nbsp;尾页{else}<a href="hot_play.php?video_id={$video[video_id].tb_video_id}&video_type={$video_types}&pages={$page1+1}">下一页</a>&nbsp;<a href="hot_play.php?video_id={$video[video_id].tb_video_id}&video_type={$video_types}&pages={$pagecount1}">尾页</a>{/if}
