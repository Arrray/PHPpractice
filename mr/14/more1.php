...
?>
  ...
  <tr>
    <td width="800" height="430" align="center" valign="top" background="images/book_111.gif"><p>&nbsp;</p>
      <p>&nbsp;</p>
...
?>
        <tr>
          <td height="30" colspan="2">
            <div align="right">共<?php echo $message_count;?>条记录 共<?php echo $page_count;?>页 当前第<?php echo $page;?>页
<?php
if($page!=1){
	echo "<a href=more1.php?page=1>首页</a>";
	echo "<a href=more1.php?page=".($page-1).">上一页</a>";
}
if($page<$page_count){
	echo " <a href=more1.php?page=".($page+1).">下一页</a>";
	echo " <a href=more1.php?page=$page_count;>尾页</a>";
}
?>
