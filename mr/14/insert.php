...
?>
  ...
  <tr>
    <td width="800" height="430" align="center" valign="middle" background="images/book_101.gif"><form action="insert_ok.php" method="post" enctype="multipart/form-data" name="form2" id="form2">
      <p>&nbsp;</p>
      <table width="527" height="321" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="415"><div align="left">
            <input name="books" type="text" id="books" size="50" />
          </div></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><div align="left">
            <input name="synopsis" type="text" id="synopsis" size="50" />
          </div></td>
        </tr>
        <tr>
          <td><div align="left">目录：</div></td>
          <td><div align="left">
            <textarea name="catalog" cols="40" id="catalog"></textarea>
          </div></td>
        </tr>
        <tr>
          <td><div align="left">文稿路径：</div></td>
          <td><div align="left">
            <input name="bookpath" type="text" id="bookpath" size="50" />
          </div></td>
        </tr>
        <tr>
          <td><div align="left">程序路径：</div></td>
          <td><div align="left">
            <input name="programpath" type="text" id="programpath" size="50" />
          </div></td>
        </tr>
        <tr>
          <td><div align="left">录像路径：</div></td>
          <td><div align="left">
            <input name="videopath" type="text" id="videopath" size="50" />
          </div></td>
        </tr>
        <tr>
