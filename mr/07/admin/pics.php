...
<table  border="1" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td align="center" valign="middle"><div id="showpic"><img src="<?php echo '../uppics/'.$picarr[0]['picpath']; ?>" name="bigimg" width="<?php echo getWidth('../uppics/'.$picarr[0]['picpath'],640,480); ?>" height="<?php echo getHeight('../uppics/'.$picarr[0]['picpath'],640,480); ?>" id = "bigimg" style="cursor:hand;" onclick="lookpic()" />
		  <div align="center" style=" line-height:25px;">图片格式：<?php echo getWidth('../uppics/'.$picarr[0]['picpath']); ?> * <?php echo getHeight('../uppics/'.$picarr[0]['picpath']); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo '<a href=mod.php?smallact='.$smallact.'&picpath=../uppics/'.$picarr[0]['picpath'].' target=_blank>修改</a> | <a onclick="javascript:if(!confirm(\'是否删除?\')){}else{ location=\'del.php?smallact='.$smallact.'&picpath=../uppics/'.$picarr[0]['picpath'].'\';}" style=" cursor: hand;">删除</a>'; ?>&nbsp;&nbsp;&nbsp;<a style="cursor:hand;" onclick="setindexpic(<?php echo $smallact; ?>)">设为封面</a></div></div></td>
	</tr>
	<tr>
		<td height="25" align="center" valign="middle"><a onclick="javascript:open('makealbum.php?act=makealbum&typename=<?php echo $smallact; ?>','_blank','',false)" style=" cursor: hand;">制作影集</a>&nbsp;<a onclick="javascript:open('try.php?typename=<?php echo $smallact; ?>','see','',false)" style="cursor: hand;">影集欣赏</a>&nbsp;<a id="autopage" style="cursor:hand;">自动翻页</a>&nbsp;间隔<input type="text" id="secondtxt" size="3" value="3" />秒</td>
	</tr>
</table>
</div>
