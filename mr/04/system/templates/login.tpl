...
<form id="login" name="login" method="post" action="#" onsubmit="return lg(this)">
  ...
  <tr>
    <td height="35" colspan="3" align="center"><input type="image" name="imageField" src="images/login.JPG" />&nbsp;&nbsp;<a href="#" id="login" onclick="reg()"><img src="images/check.JPG" width="59" height="23" border="0" /></a></td>
  </tr>
  </form>
</table>
{else}
