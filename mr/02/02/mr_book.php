...
if($link_type==0){			//判断变量的值是否等于0，如果等于0则输出首页图标，无超级连接
	...
	echo "<a href='index.php?lmbs=明日图书&vv=0&link_type=0&page=1'><img src=\"images/02.jpg\" width=\"8\" border=\"0\" height=\"9\" border=\"0\" title=\"首页\"></a>&nbsp;";
	$ccc=$vv-10;			//定义变量，变量$vv是当10页的起始位置，$ccc是上一个10页的起始位置
    echo "<a href='index.php?lmbs=明日图书&vv=$ccc&link_type=$n&page=$prev_page'><img src=\"images/01.jpg\" width=\"8\" height=\"9\" border=\"0\" title=\"上十页\"></a>";
}
?>
<?php		
...
for($j=1;$j<=$page_count;$j++) {		//根据统计的总的记录数循环输出
	...
	echo "<a href='index.php?lmbs=明日图书&vv=$vv&link_type=$link_type&page=$pnext'>"; 
...
if($page_count-$vv<=0){		//判断当总记录数小于等于下10页的起始位置时，输出尾页的图标
	...
	echo "<a href='index.php?lmbs=明日图书&vv=$vv&link_type=$m&page=$pnext'><img src=\"images/03.jpg\" width=\"8\" height=\"9\" border=\"0\" title=\"下十页\"></a>";														
}
