...
var COLOR_TABLE = Array(
						...
						"#4169E1", "#6495ED", "#B0C4DE", "#7B68EE", "#6A5ACD", "#483D8B", "#181870", "#000080", "#00008B", "#0000CD",
...
function FtDrawMedia(cmd)
{
	...
	str += '<table cellpadding="0" cellspacing="0" style="width:100%">' + 
		'<tr><td colspan="2" align="left" style="padding:5px;">'+STR_IMAGE_REMOTE+' <input type="text" id="'+cmd+'link" value="http://" style="width:180px;border:1px solid #CAD9EA;" /></td></tr>' +
...
function FtDrawIframe(cmd)
{
	...
	switch (cmd)
	{
		...
		case 'Ft_FLASH':
			var str = '';
			str += '<table cellpadding="0" cellspacing="0" style="width:100%;">' + 
			'<tr><td style="padding:8px;">地址 <input type="text" id="flashLink" value="http://" style="width:185px;border:1px solid #CAD9EA;" /></td></tr>' +
		...
		case 'Ft_LINK':
			...
			str += '<table cellpadding="0" cellspacing="0" style="width:100%">' + 
				...
				'<td style="width:200px;padding-top:5px;padding-bottom:5px;"><input type="text" id="hyperLink" value="http://" style="width:180px;border:1px solid #CAD9EA;background-color:#FFFFFF;"></td>' +
...
function CheckForm(form){
	if (myform.send_sort.value==""){alert("帖子类别不允许为空！");myform.send_sort.focus();return false;}
	if (myform.send_subject.value==""){alert("帖子标题不允许为空！");myform.send_subject.focus();return false;}
  	editor.data();//提交
