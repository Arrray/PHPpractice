...
<table width="500" border="0" cellspacing="0" cellpadding="0" class="right_table">
	...
	<td>
	{$music[sec2].actor}	</td>
	<td><img src="images/首页_24.jpg" alt="在线播放" width="28" height="23" border="0" onclick="MM_openBrWindow('listens.php?id={$music[sec2].address}','','width=1004,height=720')"></td>
...
{if $loginyon ==Y}
  {if $mymusicnum ==0}
  <p><a  class="Myfcollect" href="insert_internet_music.php" target="_blank"><span class="charcolor">{$username}&nbsp;</span>收藏的网络音乐</a></p>
  <p>当前没有记录</p>
  {else}
  
  <table border="0" cellspacing="0" cellpadding="0">
    <tr onmouseover="this.style.backgroundColor='#deebef'" onmouseout="this.style.backgroundColor=''">
       <td colspan="3"><span class="Myfcollect"><a  class="Myfcollect" href="insert_internet_music.php" target="_blank"><span class="charcolor">{$username}&nbsp;</span>收藏的网络音乐</a></span></td>
    </tr>
	<tr>
	   <td width="150" align="center" valign="middle">歌曲名称</td>
